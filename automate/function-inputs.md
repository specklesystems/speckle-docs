...
| List       | list[T] (Field(...))   | List<T> | { "type": "array", "items": {"type": "T"} } |
| Dictionary | dict[K,V] (Field(...)) | Dictionary<K,V> | { "type": "object", "properties": {"key": "value"} } |
| Speckle Object | Base (Field(...)) | Base | { "type": "speckle-object" } |
String

...
1. Run the following commands to **export the dev dependencies**
...
> ```
>
1. **Open the project folder** in VSCode and run the **`Blender: Build and Start`** command.
...
1. From `Edit -> Preferences -> Add-ons`, **enable the `Speckle Blender` plugin**.
2. A **restart of Blender** may be required upon first launch.
